...
namespace Test.StateMachine.ScriptableObjects
{
    ...
    public class TransitionTableSO : ScriptableObject
    {
        ...
        {
            var states = new List<State>(); // FromStates���� ����
            var transitions = new List<StateTransition>(); // 
            var createdInstances = new Dictionary<ScriptableObject, object>(); // ������� Instances ����뵵(State��)
            ...
            foreach (var fromState in fromStates)
            {
                ...
                // ���� fromState�� Dictionary�� ������ �ȵǾ� ������ ���� State ���� �߰�����
                var state = fromState.Key.GetState(stateMachine, createdInstances);
                states.Add(state);

                // FromState�� ���� ��� ToStates����� Trasitions�� �̾Ƴ��� ����
                transitions.Clear();
        ...
        {
            int count = conditionUsages.Length; // from ���� to �� ���� conditions �� ��

            // �� transition�� ���� conditions���� ��� �̾Ƴ��� ����
